...
public interface ProductService {
    ApiResponse<String> addProduct(User user, ReqProduct reqProduct, ProductCondition productCondition);
    ApiResponse<String> updateProduct(UUID id, User user, ReqProduct reqProduct, ProductCondition productCondition);
    ApiResponse<String> deleteProduct(UUID id, User user);
    ApiResponse<ResPageable> getAllProduct(String name, String categoryName, boolean active, int page, int size);
